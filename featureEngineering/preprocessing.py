...
if __name__ == '__main__':
    ...
    timestamp_argidx = [np.argsort(item) for item in total_timestamp_list]  # 由小到大排序

    unmatch_idx = 0
    # targid 的顺序需要和 timestamp 的顺序对应
    # 根据timestamp的顺序将targid排序
